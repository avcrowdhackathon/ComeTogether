...
<Text h4> {'\n'}{'\n'} DO WE SHARE YOUR PERSONAL DATA</Text>
          ...
          <Text >
            ...
            <Text h4> {'\n'}{'\n'} DATA RETENTION</Text>
          <Text >We keep your information only so long as we need it to fulfill the purposes described in this policy. This is also the case for anyone that we share your information with and who carries out services on our behalf. When we no longer need to use your information and there is noneed for us to keep it to comply with our legal or regulatory obliga-tions, we’ll either remove it from our systems or depersonalize it so
that we can't identify you. In any case, we won’t keep your personal data more than ten years.
          </Text>
<Text h4>{'\n'}{'\n'}YOUR RIGHTS</Text>
...
<Text h4> {'\n'}{'\n'}USE OF SERVICES BY UNDERAGED PEOPLE</Text>
          ...
          <Text>
            ...
            <Text h4>{'\n'}{'\n'}COOKIE POLICY</Text>
          <Text>
            At BackTogether, we respect your concerns about privacy and value the relationship that we have with you.{'\n'}{'\n'}Like many companies, we use technology on our website to collect in-formation that helps us enhance your experience and our services.The cookies that we use at BackTogether allow our website to work and help us to understand what information and advertising is most useful to visitors.
          </Text>
          <Text>
          ...
          <Text>{'\n'}Any personal data provided to or collected by BackTogether via cook-ies and other tracking technologies is controlled by BackTogether Private Company. By using our app, you are consenting to our use of cookies in accordance with this Cookie Notice.
          </Text>
          ...
          <Text>{'\n'}We use cookies to make BackTogether website easier to use, to deliver a personalised experience, and to better tailor our services and websites to your interests and needs. Cookies are used to help speedup your future activities and your experience on BackTogether app.
          </Text>
